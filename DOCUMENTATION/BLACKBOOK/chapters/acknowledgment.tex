...
\fancyhf{}
\fancyfoot[R]{\thepage}
\fancyfoot[L]{BEProjectReportCP5For2025}
\fancyhead[L]{AUTOMOTIVE DIAGNOSTIC AND ACTIVITY MONITORING (ADAM) SYSTEM}
\renewcommand{\headrulewidth}{0pt}

% Now redefine chapter to use fancy on its opening page
\titleformat{\chapter}[display]{\normalfont\Huge\bfseries\centering}{\thechapter}{20pt}{}
