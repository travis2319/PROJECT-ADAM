...
\begin{enumerate}
    \item \textbf{Sensor and Hardware Layer:}
        \begin{table}[h!]\centering
            ...
            \end{tabular}
        \end{table}    
        At the core of the system lies the Raspberry Pi 5, which functions as the primary edge computing device. It interfaces with multiple onboard sensors and modules
