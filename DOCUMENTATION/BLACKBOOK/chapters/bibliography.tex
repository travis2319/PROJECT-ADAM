...
\begin{enumerate}
    ...
    \item CS Selectronics, \textbf{"CAN Bus Intros and Tutorials,"} Available online: \url{https://www.csselectronics.com/pages/can-bus-intros-tutorials}. [Accessed: 1-Jul-2025].

    \item Operation CHARM, \textbf{"Free Car Service Manuals for 50,000+ Models (1982-2013)," } Available online: \url{https://charm.li/}. [Accessed: 1-Jul-2025]. :contentReference[oaicite:1]{index=1}

    \item Wikipedia, \textbf{"Wikipedia: The Free Encyclopedia,"} Available online: \url{https://www.wikipedia.org/}. [Accessed: 1-Jul-2025].

    \item IEEE Xplore, \textbf{"IEEE Xplore Digital Library,"} Available online: \url{https://ieeexplore.ieee.org/}. [Accessed: 1-Jul-2025].

    \item Robu.in, \textbf{"Robotics Parts, Sensors and Laser Cutting Services,"} Available online: \url{https://robu.in/}. [Accessed: 1-Jul-2025].

    \item Google Colaboratory, \textbf{"Google Colab — Free Cloud-Based Python Notebooks,"} Available online: \url{https://colab.research.google.com/}. [Accessed: 1-Jul-2025].

    \item Brendan-W, \textbf{"python-OBD: A Python Library for OBD-II Communication,"} Available online: \url{https://github.com/brendan-w/python-OBD}. [Accessed: 1-Jul-2025].

    \item Ircama, \textbf{"ELM327 Emulator: Python-Based OBD-II Emulator,"} Available online: \url{https://github.com/Ircama/ELM327-emulator}. [Accessed: 1-Jul-2025].

    \item Supabase, \textbf{"Supabase — Open Source Firebase Alternative,"} Available online: \url{https://supabase.com/}. [Accessed: 1-Jul-2025].

    \item GeeksforGeeks, \textbf{"GeeksforGeeks — Computer Science and Programming Tutorials,"} Available online: \url{https://www.geeksforgeeks.org/}. [Accessed: 1-Jul-2025].

    \item Expo Documentation, \textbf{"Expo — Documentation for React Native Development,"} Available online: \url{https://docs.expo.dev/}. [Accessed: 1-Jul-2025].
