      ...
      <ScrollView>
        <View className='flex-1 p-12 bg-[#f1f4de] gap-6'>
          ...
          <DataCard 
            ...
            icon={<MaterialCommunityIcons name='engine' size={32} color="#000000" />}
          ...
          <DataCard 
            ...
            icon={<FontAwesome5 name='shipping-fast' size={32} color="#000000" />}
          ...
          <DataCard 
            ...
            icon={<FontAwesome5 name='tools' size={32} color="#000000" />}
