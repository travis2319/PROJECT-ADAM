import time
from obd.connection import async_connection
from obd.data_collection import initialize_supported_pids, collect_data
from obd.utils import save_data_to_csv
...
def main(obd_connector, sleep_interval=30):
    ...
    try:
        while True:
            ...
            save_data_to_csv(df, 'dataset/kai1.csv')
...
if __name__ == "__main__":
    ...
    main(obd_connector, sleep_interval=10)
